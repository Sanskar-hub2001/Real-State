      ...
      >
        <div className='flex flex-col justify-center items-start gap-5'>
          ...
          <p className='text-slate-200 text-justify'>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. A quisquam sit iste minus, laboriosam
            excepturi iusto reprehenderit odio nam ipsam.
          </p>
        ...
        <div className='flex flex-col justify-center items-start gap-5'>
          ...
          <div className='flex-justify-center items-center gap-3'>
            ...
            <p className='text-slate-200'> Buckingham Palace, London, United Kingdom</p>
          </div>
          <div className='flex-justify-center items-center gap-3'>
            <FaMobile className='text-white size-5 ' />
            <p className='text-slate-200'>+918 826 7262</p>
          </div>
          <div className='flex-justify-center items-center gap-3'>
            <FaFax className='text-white size-5 ' />
            <p className='text-slate-200'>8267 12127</p>
          </div>
          <div className='flex-justify-center items-center gap-3'>
        ...
        <div className='flex flex-col justify-center items-start gap-5'>
          ...
          <div className='flex justify-center items-center gap-4'>
            ...
            <div>
              ...
              <p className='text-slate-400'>$ 897.87 </p>
            </div>
          </div>
          <div className='flex justify-center items-center gap-4'>
            ...
            <div>
              ...
              <p className='text-slate-400'>$ 1098.87 </p>
            </div>
          </div>
        </div>
      </footer>
